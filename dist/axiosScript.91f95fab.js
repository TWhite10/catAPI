...
},{"bootstrap":"node_modules/bootstrap/dist/js/bootstrap.esm.js","./index.js":"index.js"}],"axiosScript.js":[function(require,module,exports) {
"use strict";
        ...
        case 3:
          ...
          breedSelect.addEventListener("change", function (event) {
            ...
            function updateProgress(progressEvent) {
              ...
              console.log("Loading: ".concat(Math.round(percent), "%"));
            }
            _axios.default.get("https://api.thecatapi.com/v1/images/search?breed_ids=".concat(selectedBreedId, "&limit=10"), {
...
_axios.default.interceptors.request.use(function (config) {
  console.log("".concat(config.method.toUpperCase(), " sent request to ").concat(config.url, " at ").concat(new Date().getTime()));
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","axiosScript.js"], null)
//# sourceMappingURL=/axiosScript.91f95fab.js.map